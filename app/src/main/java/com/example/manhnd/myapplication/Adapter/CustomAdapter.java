package com.example.manhnd.myapplication.Adapter;
...
import com.example.manhnd.myapplication.R;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null)
        {
            if(list_chat_models.get(position).isSend)
                view = layoutInflater.inflate(R.layout.list_item_massger_send,null);
            else
                view = layoutInflater.inflate(R.layout.list_item_massage_rev,null);
